...
public interface QProductDao {
	 ...
	 * @throws Exception
	 */
	public Integer isExsitProductByModuleNo(@Param("moduleNo") String moduleNo,@Param("qdsProCategoryId") int qdsProCategoryId) throws Exception;
	 ...
	 * @throws Exception
	 */
	public void updateTestStatusQdsProductByModuleNo(@Param("moduleNo") String moduleNo,
													 @Param("testStatus") int testStatus) throws Exception;
	 ...
	 * @throws Exception
	 */
	public Integer getTestStatusByModuleNo(@Param("moduleNo") String moduleNo,
										   @Param("qdsProCategoryId") int qdsProCategoryId) throws Exception;
