...
<script type="text/javascript">var qdsMain='${qdsMainList}';var modifyStatus='${modifyStatus}'</script>
</head>
				...
				<div class="left_col scroll-view">
					<div class="navbar nav_title" style="border: 5px;">
						<a href="${pageContext.request.contextPath }/main" class="site_title">
							<i class="fa fa-paw"></i>
							<span style="color:white;">QDS系统</span>
						</a>
					</div>
					...
					<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
						<div class="menu_section">
							...
							<ul class="nav side-menu" id="qdsMenu">
								<!-- use qdsjs/qdsReady.js to onload qdsMenu -->
							</ul>
						</div>
					</div>
					<!-- /sidebar menu -->
