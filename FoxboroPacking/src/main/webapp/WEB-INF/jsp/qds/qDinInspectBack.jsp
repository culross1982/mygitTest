...
<div class="row">
	<div class="col-md-12">
		<div class="x_panel">
			<div class="x_title">
				<h2>
					DIN数据检验 <i class="fa fa-user"></i><small> ${sessionScope.user.realname } --- 您可以对DIN数据进行检验操作</small>
				</h2>
				<div class="clearfix"></div>
			</div>
			<%-- <div class="x_content">
							...
							<li>
								<div class="form-group">
									...
									<div class="col-md-9 col-sm-9 col-xs-12">
										<input name="testNo" type="text" class="form-control col-md-7 col-xs-12" value="${qProTest.testNo }" pattern="[0-9a-zA-Z]*" placeholder="请输入卡件串号">
									</div>
								</div>
							</li>
						...
						<div class="col-sm-12">
							<div class="modifyStatus">
								<form action="${pageContext.request.contextPath}/qds/addDinTestFromLog" method="post" enctype="multipart/form-data"
									onsubmit="return checkSuffix();" class="form-inline">
									<div class="form-group">
								...
								<thead>
									<tr role="row" class="success">
										...
										<th class="sorting" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 60px;"
											aria-label="Last name: activate to sort column ascending">卡件串号</th>
										...
										<th class="sorting" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 80px;"
											aria-label="Last name: activate to sort column ascending">测试时间 <%-- <div class="pull-right">
								...
								<tbody>
									<c:forEach var="t" items="${qdsProductTestList }" varStatus="status">
										<tr role="row" class="odd">
											...
											<td><a class="modifyDinAssy operation" data-toggle="tooltip" id=${a.id } realname=${a.realname } partNo=${a.partNo } assyNo=${a.assyNo } 
											       assyTime=<fm:formatDate value="${a.assyTime}" pattern="yyyy-MM-dd HH:mm:ss" /> data-placement="top" 
											       data-original-title="修改装配数据" style="cursor: pointer">修改</a>&nbsp;&nbsp;
												<a class="deleteDinAssy operation modifyStatus" data-toggle="tooltip" id=${a.id } assyNo=${a.assyNo } data-placement="top"
												   data-original-title="删除装配数据" style="cursor: pointer">删除</a></td> --%>
										</tr>
									</c:forEach>
								</tbody>
							</table>
