			...
			<div class="x_title">
				<h2>
					产品使用包材 <i class="fa fa-user"></i><small>
						${sessionScope.user.realname } --- 请您选择产品分类》产品型号》填写数量，打（★）为必填项。 </small>
				</h2>
				<div class="clearfix"></div>
			</div>
			<div class="x_content">
				<div class="clearfix"></div>
				<div id="add">
					<form class="form-horizontal form-label-left" style="width:900px" action="###" method="post" >
						<div id="proLeft">
							<div class="item ">
							...
							<div class="item " style="margin: 5px">
								<label for="select">产品分类（<span class="red">★</span>）： </label> <select required
							...
							<div class="item " style="margin: 5px">
								<label for="select">产品型号（<span class="red">★</span>）： </label> 
								<select id="pwd" name="pwd" style="height: 25px;width:172px">
								</select>
							</div>
							
							<div class="item ">
								<label for="pwdQuantity">数量（<span class="red">★</span>）：</label> <input type="text" placeholder="请输入数量" pattern="[1-9]*[1-9][0-9]*"
						...
						<div id="proLeft" style="margin: 0 10px 0 20px;">
							<div class="item ">
								<label for="boxQuantity">使用包装盒总数：</label> <input type="text"
									name="boxQuantity" size="4" id="boxQuantity" readonly="readonly"/>
							</div>
							<div class="item ">
								<label for="gasketQuantity">使用衬垫总数：</label> <input type="text"
									name="gasketQuantity" size="4" id="gasketQuantity" readonly="readonly"/>
							</div>
							<div class="item ">
								<label for="spongiaOneQuantity">使用变化海绵总数：</label> <input type="text"
									name="spongiaOneQuantity" size="4" id="spongiaOneQuantity" readonly="readonly"/>
							</div>
							<div class="item ">
								<label for="spongiaTwoQuantity">使用固定海绵总数：</label> <input type="text"
									name="spongiaTwoQuantity" size="4" id="spongiaTwoQuantity" readonly="readonly"/>
							</div>
							<div class="item ">
								<label for="esdBagQuantity">使用静电袋总数：</label> <input type="text"
									name="esdBagQuantity" size="4" id="esdBagQuantity" readonly="readonly"/>
							</div>
							<div class="item ">
								<label for="geDangQuantity">使用隔档总数：</label> <input type="text"
									name="geDangQuantity" size="4" id="geDangQuantity" readonly="readonly"/>
							</div>
							
							<!-- 不订购，屏蔽此字段，hidden -->
							<div class="item hidden">
								<label for="esdTableQuantity">使用静电铭牌总数：</label> <input type="text"
						...
						<div class="form-group" style="width:700px;">
							<div class="col-md-6 col-md-offset-3" style="margin-top:20px">
								<button id="ProUseMateBtn" type="button" class="btn btn-success" onclick="document.getElementById('productCategoryId').focus();" >使用</button>
...
<script src="${pageContext.request.contextPath }/statics/packingjs/proUseMateOut.js"></script>