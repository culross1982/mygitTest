   ...
   <%--  <script src="${pageContext.request.contextPath }/statics/js/responsive.bootstrap.js"></script>
    ...
    <%-- <script src="${pageContext.request.contextPath }/statics/tablesjs/custom.min.js"></script> --%>
    <script src="${pageContext.request.contextPath }/statics/js/custom.min.js"></script>
  
  	<!-- humane-->
  	<script src="${pageContext.request.contextPath }/statics/humane/humane.js"></script>
  	<!-- onload menu -->
    <script src="${pageContext.request.contextPath }/statics/configjs/configReady.js"></script> 